    ...
    <div v-else class="h-full rounded-lg border border-gray-200 bg-white">
        ...
        <form @submit.prevent="handleSubmit" class="space-y-4 p-4">
            ...
            <div class="flex justify-end gap-2 pt-2">
                <button type="button" @click="emit('cancel')" class="rounded-md border border-gray-300 px-4 py-2 text-sm text-gray-600 transition hover:bg-gray-100">Batal</button>
